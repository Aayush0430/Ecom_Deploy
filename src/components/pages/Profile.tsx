...
const Profile = () => {
  ...
  async function getUserData() {
    ...
    const { data: resData } = await axios.post(
      `${process.env.NEXT_PUBLIC_DOMAIN_NAME}api/users/getuserdata`,
      {
        uid,
      }
    );
  ...
  async function getProfileData() {
    const { data: resData } = await axios.post(
      `${process.env.NEXT_PUBLIC_DOMAIN_NAME}api/users/getprofiledata`,
      {
        uid,
      }
    );
  ...
  async function handleSave() {
    ...
    const { data: resData } = await axios.post(
      `${process.env.NEXT_PUBLIC_DOMAIN_NAME}api/users/setprofiledata`,
      {
        uid,
        firstName,
        lastName,
